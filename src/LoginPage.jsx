...
const RightColumnFooter = () => (
  <div className="right-footer">
    <div className="right-footer-links">
      <a href="#" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
      <a href="#" target="_blank" rel="noopener noreferrer">Terms of Service</a>
      <a href="#" target="_blank" rel="noopener noreferrer">Help & Support</a>
    </div>
    <div className="right-footer-icons">
      <a href="https://www.linkedin.com/company/telekom-malaysia-berhad/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
